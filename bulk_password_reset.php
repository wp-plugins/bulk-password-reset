	...
	class bulk_password_reset {
		 ...
		 */
				...
				function sent_activation_mail($user_login) {
					...
					$message .= sprintf(__('Hello, \r\n\r\nThe site administrator of %s has automatically requested to changes your password due to violation issues.', 'bulk_password_reset'), get_option('siteurl')) . "\r\n\r\n";
					...
					$message .= __('Kind regards,\r\n\r\nThe admin team of the website', 'bulk_password_reset');
